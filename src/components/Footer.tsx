...
export function Footer() {
  ...
  return (
    <>
      <footer className="py-16 px-6 lg:px-12 bg-black border-t-[5px] border-gauge-coral-2">
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="flex items-center gap-4 text-base md:text-lg font-sans text-gray-400">
              <a href="mailto:hello@gauge.io" className="flex items-center gap-2 text-gauge-coral-2 hover:text-gauge-coral-2/80 transition-colors">
                <Mail className="w-5 h-5" />
                <span>hello@gauge.io</span>
              </a>
              <span>|</span>
              <a href="tel:5105605472" className="flex items-center gap-2 hover:text-white transition-colors">
                <Phone className="w-5 h-5" />
                <span>510 560 5472</span>
              </a>
              <span>|</span>
              <Link to="/coffee" className="flex items-center gap-2 hover:text-white transition-colors" title="Face to Face In Real Life">
