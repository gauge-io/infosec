...
export function HeroSection() {
  return <section className="relative min-h-[85vh] flex items-center pt-20 md:pt-24">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-start gap-4 md:gap-6 mb-8">
            ...
            <div className="flex-1">
              ...
              <p className="text-xl md:text-2xl lg:text-3xl font-sans text-white max-w-4xl font-medium mb-8" style={{ lineHeight: '1.70625', textIndent: '-6px' }}>
              ...
              {/* Industry Badges - Left-aligned with headline and description text */}
              <div className="flex flex-wrap gap-4">
                {industries.map((industry, index) => <a key={index} href={industry.url} target="_blank" rel="noopener noreferrer" className="px-6 py-3 bg-gauge-coral-3 bg-opacity-25 text-white font-sans text-base font-semibold rounded-md hover:bg-opacity-35 transition-all duration-300">
                    {industry.name}
                  </a>)}
              </div>
            </div>
